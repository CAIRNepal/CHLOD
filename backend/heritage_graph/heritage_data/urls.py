...
from .views import SubmissionCreateView, SubmissionListView, ModerationReviewView, UserRegistrationView, CustomUserMeView, ActivityLogView, LeaderboardView, UserDetailView, SubmissionDetailView

urlpatterns = [
    path('submissions/', SubmissionListView.as_view(), name='submission-list'), 
    path('submissions/<str:title>/', SubmissionDetailView.as_view(), name='submission-detail'),
    path('data/submissions/create/', SubmissionCreateView.as_view(), name='create_submission'),
